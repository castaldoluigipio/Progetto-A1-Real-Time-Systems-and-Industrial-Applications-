...
CSV_FILE = "benchmark_results_cpu_7.0_v3.csv" 
...
def main():
    ...
    for temp in df_filtered['Temperatura'].unique():
        generate_degradation_curves(df_filtered, temp, f"task6_degradation_curves_temp_{temp}_cpu.png")
        generate_sensitivity_heatmap(df_filtered, temp, f"task6_sensitivity_heatmap_temp_{temp}_cpu.png")
    ...
    for temp in temperatures:
        ...
        for col_name, config in metrics_to_plot.items():
            ...
            filename = f"box_dim_{col_name}_temp_{temp}_cpu.png"
